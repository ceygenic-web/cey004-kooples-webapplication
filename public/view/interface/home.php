    ...
    <div class="container py-5">
        ...
        <div class="d-flex flex-column">
            <div class="d-flex flex-wrap">
                <div onclick="toPage('/shop?category=Rayon Collection')" class="p-4 col-md-4 lp-s4-card d-flex align-items-end col-12 lp-s4-large-card" style="background-image: url('/public/resources/images/category1.jpg');">
                    <div class="d-flex flex-column">
                        <h4 class="fw-bold cey-text-white">Rayon</h4>
                        <p class="cey-text-white">EXPLORE -></p>
                    </div>
                </div>
                <div onclick="toPage('/shop?category=Cotton Collection')" class="p-4 col-md-4 lp-s4-card d-flex align-items-end col-12 lp-s4-large-card" style="background-image: url('/public/resources/images/category2.jpg');">
                    <div class="d-flex flex-column">
            ...
            <!-- <div class="d-flex flex-wrap">
                <div onclick="toPage('/shop?category=category 3')" class="col-6 col-md-3 lp-s4-card d-flex align-items-end p-4 lp-s4-small-card" style="background-image: url('/public/resources/images/category3.jpg');">
                    <div class="d-flex flex-column">
                        <h4 class="fw-bold cey-text-white">CATEGORY 1</h4>
                        <p class="cey-text-white">EXPLORE -></p>
                    </div>
                </div>
                <div class="col-6 col-md-3 lp-s4-card d-flex align-items-end p-4 lp-s4-small-card" style="background-image: url('/public/resources/images/category4.jpg');">
                    <div class="d-flex flex-column">
                        <h4 class="fw-bold cey-text-white">CATEGORY 1</h4>
                        <p class="cey-text-white">EXPLORE -></p>
                    </div>
                </div>
                <div class="col-6 col-md-3 lp-s4-card d-flex align-items-end p-4 lp-s4-small-card" style="background-image: url('/public/resources/images/category5.jpg');">
                    <div class="d-flex flex-column">
                        <h4 class="fw-bold cey-text-white">CATEGORY 1</h4>
                        <p class="cey-text-white">EXPLORE -></p>
                    </div>
                </div>
                <div class="col-6 col-md-3 lp-s4-card d-flex align-items-end p-4 lp-s4-small-card" style="background-image: url('/public/resources/images/category6.jpg');">
                    <div class="d-flex flex-column">
                        <h4 class="fw-bold cey-text-white">CATEGORY 1</h4>
                        <p class="cey-text-white">EXPLORE -></p>
                    </div>
...
<!-- <section class="lp-s5 cey-bg-dark">
    <div class="container py-5">
        ...
        <div class="d-flex flex-column flex-md-row">
            <div style="background-image: url('/public/resources/images/blog1.jpg');" class="lp-s5-card">
            ...
            <div style="background-image: url('/public/resources/images/blog2.jpg');" class="lp-s5-card">
                <h5 class="fw-bold"><a href="#" class="text-white text-decoration-none">Blog Title</a></h5>
                <p>this part consists of small part of the actual blog content and it should not be
                    longer than 2 lines</p>
            </div>
...
<section class="lp-s8 cey-bg-white">
    <div class="h-100 d-flex flex-column flex-lg-row">
        <div class="lp-s8-section lp-s8-sides" style="background-image: url('/public/resources/images/ourstory-left.jpg');"></div>
        ...
        <div class="lp-s8-section lp-s8-sides" style="background-image: url('/public/resources/images/ourstory-right.jpg');"></div>
    </div>
</section>
...
<section class="lp-s8 cey-bg-darker px-5">
    <div class="container d-flex justify-content-center py-4">
        <!-- <video loop height="678" src="/public/resources/video/main.mp4" autoplay></video> -->
...
<?php include(__DIR__ . "/../component/custom/visionmission.php") ?>
...
<?php include(__DIR__ . "/../component/custom/newsletter.php") ?>