...
<section class="productAdd ad-s1 cey-bg-dark py-5">
    <div class="container py-5 d-flex justify-content-center align-items-center h-100 w-100 flex-column">
        ...
        <form id="productAdd" class="col-12 col-lg-6 col-md-8 d-flex flex-column gap-1 cey-text-white">
            ...
            <input type="text" id="add_price" name="price" class="form-control"><br>
