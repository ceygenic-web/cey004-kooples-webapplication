...
<section class="cey-bg-white ls-s11 p-5">
    <div class="container">
        ...
        <div class="ls-s11-detail-box gap-3 col-lg-12 col-md-12">
            ...
            <div class="ls-s11-right-box  cey-bg-dark cey-text-white d-flex flex-column justify-content-center col-lg-6 col-md-6">
