...
<section class="lp-s8 cey-bg-darker px-5">
    <div class="container d-flex justify-content-center py-4">
        ...
        <div style="position: relative; height: 400px; width: 100%;" class="overflow-hidden">
            <iframe style="scale: 140%;width: 100%; height: 100%; top: 0; left: 0;" src="https://www.youtube.com/embed/s4M-Zwom93Y?si=wO2_QHXNFwimLgSK&rel=0&version=3&mute=1&autoplay=1&controls=0&&showinfo=0&loop=1&iv_load_policy=3&playlist=QTdl4LazLdI" title="YouTube video player" frameborder="0" allow="autoplay;"></iframe>
